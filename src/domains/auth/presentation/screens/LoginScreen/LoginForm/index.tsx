...
import { CInput, CButton, IconComp } from '~shared/presentation/ui';
import { spacing, useColors } from '~shared/presentation/design';
import { validateEmail, validatePassword } from '~shared/utils/validation';
import { useSignIn } from '~domains/auth/application/authMutations';
import { getApiErrorMessage } from '~shared/domain/errors';
import { toAuthUser } from '~domains/auth/application/mappers';
import { useAppDispatch } from '~shared/infrastructure/state/hooks';
import { loginData } from '~shared/infrastructure/state/slices/userSlice';
